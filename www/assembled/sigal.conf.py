...
title = "Weather sensors & remote control"
...
author = 'weather-sensors-n-remote-control @ github.com'
...
links = [('Back to weather-sensors-n-remote-control @ github.com', 'https://github.com/pskowronek/weather-sensors-n-remote-control#screenshots--photos') ]
...
copyright = "https://github.com/pskowronek/weather-sensors-n-remote-control (CC BY-NC)"
